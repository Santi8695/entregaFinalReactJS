  ...
  return (
    <div className="cartItem">
      <div className="productoComprado">
        <img src={item.img} alt={item.nombre} /> {/* Ahora mostrará la imagen correcta */}
